...
//Creating a table in our_first_db database:
...
//Inserting data into table orders caching:
...
// Run this query twice to see how caching works.
SELECT * FROM ORDERS_CACHING  WHERE DATE = '2020-06-10';

// Adding Cluster Key & Compare the result
ALTER TABLE ORDERS_CACHING CLUSTER BY ( DATE ); 

SELECT * FROM ORDERS_CACHING  WHERE DATE = '2020-03-09';