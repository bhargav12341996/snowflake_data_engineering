...
GRANT ROLE ANALYST_MASKED TO USER BHARGAV1996;
GRANT ROLE ANALYST_FULL TO USER BHARGAV1996;
...
--This policy cannot be easily dropped because it is attached to two columns full_name and phone.
DROP masking policy phone;

--This policy cannot be easily modified, because it is attached to two columns full_name and phone.
...
-- Remove policy from attached columns and the try replacing/dropping the policy:
ALTER TABLE IF EXISTS CUSTOMERS MODIFY COLUMN full_name
